...
$except = NULL;
// Create WebSocket.
    // for single socket create need -> socket_create
    // for multi socket create need -> 
        // $sockets = array();
        // socket_create_pair(AF_INET, SOCK_STREAM, SOL_TCP, $sockets)   
...
while (true) {
    ...
    if (in_array($server, $changed)) {
        ...
        //send msg to client
            ...
            //send success msg
            //send_message($response);  multiple connection send same data
        ...
        //received msg from client
            ...
            //process two
                // while (@socket_recv($newSocket, $data, 8192, 0)) {
                //     echo unmask($data);
                // }
    }
    $connection++;
